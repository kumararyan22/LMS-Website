...
const AddCourse = () => {
  ...
  if (action === 'add') {
    ...
    if (title) {
      const newChapter = {
        ...
        chapterContent: [],
        collapsed: false,
        chapterOrder: chapters.length > 1 ? chapters.slice(-1)[0].chapterOrder + 1 : 1
      };
  ...
  return (
    <div className='h-screen overflow-scroll fle flex-col items-start justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0 '>
      <form onSubmit={handleSubmit} className='flex flex-col gap-4 max-w-md w-full text-gray-500'>
       ...
       <div className='flex items-center justify-between flex-w'>
        <div className='flex flex-col gap-1'>
          <p>Cource Price</p>
        ...
        <div className='flex md:flex-row flex-col items-center gap-3'>
          ...
          <lebel htmlFor='thumbnailImage' className='flex items-center gap-3'>  
              ...
              <div key={chapterIndex} className='bg-white rounded-lg border mb-4'>
               <div className='flex justify-between items-center p-4 border-b'>
                <div className='flex items-center'>
                  <img src={assets.dropdown_icon} width={14} className={`mr-2 cursor-pointer transition-all ${chapter.collapsed && "-rotate-90"}`} onClick={()=> handleChapter('toggle', chapter.chapterId)}/>
          ...
          {showPopup && (
            <div className='fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50'>
              <div className='bg-white text-gray-700 p-4 rounded relative w-full max-w-80'>
                ...
                <button type='button' onClick={addLecture} className='w-full bg-blue-400 text-white px-4 py-3 rounded'> Add </button>
